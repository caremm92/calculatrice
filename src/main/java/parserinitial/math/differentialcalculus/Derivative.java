...
public class Derivative {
    ...
    Derivative(String expression) throws Exception {
        String mathExpr = "";
        if (Utilities.isAutoGenNameFormat(expression)) {
    ...
    public ArrayList<String> translateToBaseTerms(Differentiable d) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            if (Utilities.isAutoGenNameFormat(data.get(i))) {
    ...
    public ArrayList<String> differentiateAsList() {
        ...
        Utilities.print("Here is the chain---" + builder.getManager().getDIFFERENTIABLES());
        ...
        for (int i = 0; i < array.size(); i++) {
            try {
                if (Utilities.isAutoGenNameFormat(array.get(i))) {
