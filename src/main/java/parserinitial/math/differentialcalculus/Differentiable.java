...
public class Differentiable {
    ...
    public boolean isChain(){
        return Utilities.isAutoGenNameFormat(name);
    }//end method
    ...
    public ArrayList<String> differentiate(Derivative d){
        ...
        if( sz == 3 ){
            if( isOpeningBracket(data.get(0)) && isVariableString(data.get(1)) && isClosingBracket(data.get(2)) ){
                ...
                else if(Utilities.isAutoGenNameFormat(data.get(1))){
            ...
            //pattern sin,(,var,)
            if(Method.isMethodName(data.get(0))&&isOpeningBracket(data.get(1))&&isVariableString(data.get(2))&&isClosingBracket(data.get(3))){
        ...
        //pattern (,num|var,operator,num|var,)
            ...
            if( Method.isMethodName(data.get(0)) && isOpeningBracket(data.get(1)) && data.get(2).equals("-") && isVariableString(data.get(3))
        ...
        Utilities.print("data---"+data+"---Diff of data = derivedData---"+derivedData);
        return derivedData;
    }//end method
